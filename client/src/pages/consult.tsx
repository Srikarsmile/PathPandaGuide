        ...
        <section className="py-16 md:py-24">
          <div className="container px-4 mx-auto">
            <div className="max-w-3xl mx-auto">
              ...
              {isSuccess ? (
                <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-5 sm:p-6 md:p-10 text-center">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-green-100 dark:bg-green-900/20 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6">
                  ...
                  <p className="text-sm sm:text-base md:text-lg text-gray-600 dark:text-gray-300 mb-6 md:mb-8">
                  ...
                  <div className="space-y-3 md:space-y-0 md:flex md:space-x-4 justify-center">
                    ...
                    <Button 
                      className="w-full md:w-auto bg-panda-purple hover:bg-panda-purple/90 text-sm sm:text-base"
                ...
                <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-5 sm:p-6 md:p-10 border border-gray-100 dark:border-gray-700">
                  <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5 md:space-y-6">
                      <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-gray-700 dark:text-gray-300 text-sm md:text-base">Full Name</FormLabel>
                              <FormControl>
                                <Input 
                      ...
                      <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-gray-700 dark:text-gray-300 text-sm md:text-base">
                                Phone Number <span className="text-gray-400 text-xs md:text-sm">(Optional)</span>
                              </FormLabel>
                              <FormControl>
                                <Input 
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-gray-700 dark:text-gray-300 text-sm md:text-base">Current Country</FormLabel>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <FormControl>
                                  <SelectTrigger className="rounded-lg text-sm md:text-base h-10 md:h-auto">
                      ...
                      <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-gray-700 dark:text-gray-300 text-sm md:text-base">Study Level</FormLabel>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <FormControl>
                                  <SelectTrigger className="rounded-lg text-sm md:text-base h-10 md:h-auto">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-gray-700 dark:text-gray-300 text-sm md:text-base">Field of Study</FormLabel>
                            <FormControl>
                              <Input 
                      ...
                      <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-col">
                              <FormLabel className="text-gray-700 dark:text-gray-300 text-sm md:text-base">Preferred Consultation Date</FormLabel>
                              <Popover>
                                <PopoverTrigger asChild>
                                  <FormControl>
                                    <Button
                                      variant={"outline"}
                                      className={cn(
                                        "w-full pl-3 text-left font-normal rounded-lg text-sm md:text-base h-10 md:h-auto",
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-gray-700 dark:text-gray-300 text-sm md:text-base">Preferred Time</FormLabel>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <FormControl>
                                  <SelectTrigger className="rounded-lg text-sm md:text-base h-10 md:h-auto">
                      ...
                      <div className="pt-1 md:pt-2">
                        <Button 
                          ...
                          className="w-full md:w-auto bg-panda-purple hover:bg-panda-purple/90 text-white py-4 sm:py-5 md:py-6 px-6 sm:px-7 md:px-8 rounded-lg md:rounded-xl text-sm sm:text-base md:text-lg flex items-center justify-center"
                        >
                          {isSubmitting ? (
