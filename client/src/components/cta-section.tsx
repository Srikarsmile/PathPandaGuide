        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-6 sm:p-8 md:p-12 shadow-2xl border border-white/20 max-w-5xl mx-auto">
          <div className="grid md:grid-cols-5 gap-6 md:gap-8 items-center">
            <div className="md:col-span-3">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] mb-4 md:mb-6 leading-tight">
                Ready to Start Your <span className="text-panda-yellow drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">Study Abroad</span> Journey?
              </h2>
              <p className="text-base sm:text-lg md:text-xl text-white font-medium drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)] mb-6 md:mb-8 max-w-2xl">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4 items-center">
                <div className="flex items-center bg-white/30 rounded-lg px-3 py-1.5 md:px-4 md:py-2 text-white text-sm md:text-base shadow-md">
                  <Calendar className="h-4 w-4 md:h-5 md:w-5 mr-1.5 md:mr-2" />
                  <span className="font-medium drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">Free 30-min session</span>
                </div>
                <div className="flex items-center bg-white/30 rounded-lg px-3 py-1.5 md:px-4 md:py-2 text-white text-sm md:text-base shadow-md">
                  <svg className="h-4 w-4 md:h-5 md:w-5 mr-1.5 md:mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="font-medium drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">No obligation</span>
                </div>
              </div>
            </div>
            <div className="md:col-span-2 mt-6 md:mt-0">
              <div className="bg-white/20 backdrop-blur-md rounded-2xl p-5 md:p-8 shadow-lg border border-white/20">
                <h3 className="text-xl md:text-2xl font-bold text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] mb-4 md:mb-6 text-center">Book Your Session</h3>
                <Link href="/consult">
                ...
                <p className="text-center text-white mt-3 md:mt-4 text-xs md:text-sm font-medium drop-shadow-[0_1px_2px_rgba(0,0,0,0.6)]">
